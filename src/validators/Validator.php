...
class Validator
{
    ...
    public static $builtInValidators = [
        'boolean' => 'Validator\validators\BooleanValidator',
        'captcha' => 'Validator\captcha\CaptchaValidator',
        'compare' => 'Validator\validators\CompareValidator',
        'date' => 'Validator\validators\DateValidator',
        'datetime' => [
            'class' => 'Validator\validators\DateValidator',
        ...
        'default' => 'Validator\validators\DefaultValueValidator',
        'double' => 'Validator\validators\NumberValidator',
        'each' => 'Validator\validators\EachValidator',
        'email' => 'Validator\validators\EmailValidator',
        'exist' => 'Validator\validators\ExistValidator',
        'file' => 'Validator\validators\FileValidator',
        'filter' => 'Validator\validators\FilterValidator',
        'image' => 'Validator\validators\ImageValidator',
        'in' => 'Validator\validators\RangeValidator',
        'integer' => [
            'class' => 'Validator\validators\NumberValidator',
            'integerOnly' => true,
        ],
        'match' => 'Validator\validators\RegularExpressionValidator',
        'number' => 'Validator\validators\NumberValidator',
        'required' => 'Validator\validators\RequiredValidator',
        'safe' => 'Validator\validators\SafeValidator',
        'string' => 'Validator\validators\StringValidator',
        'trim' => [
            'class' => 'Validator\validators\FilterValidator',
            'filter' => 'trim',
            'skipOnArray' => true,
        ],
        'unique' => 'Validator\validators\UniqueValidator',
        'url' => 'Validator\validators\UrlValidator',
        'ip' => 'Validator\validators\IpValidator',
    ];
    /**
